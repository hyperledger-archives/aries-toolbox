...
- The first example for each protocol message is for general usage; the second example specific to the

### Protocol Messages
- [Invitations Admin Protocol](#invitations-admin-protocol)
  - [Overview](#overview)
    - [Notes](#notes)
